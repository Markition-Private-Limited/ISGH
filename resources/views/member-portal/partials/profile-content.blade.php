{{-- Profile page content — six cards as direct children of #profilePage.
     ...
     sits beside (and matches the height of) its edit form:
       ...
       Row 3 · Spouse Information form  | Spouse Profile card  (if spouse) --}}

@php $spouse = $profile->hasSpouse() ? $profile->spouse() : null; @endphp
...
<div class="card">
  ...
  <form class="form-grid" id="formSpouse" novalidate>
    ...
    <div class="field"><label for="s-dob">Date of Birth<span class="req">*</span></label><input type="text" id="s-dob" value="{{ $spouse->dobMdy() }}" placeholder="MM/DD/YYYY" readonly /></div>
...
{{-- ── Row 3 · right: Spouse Profile card ── --}}
