...
<head>
  ...
  <title>Financial Report — ISGH</title>
...
<div class="app">
  ...
  <div class="main">
    ...
    <section class="content">
      <h2 class="section-heading">ANNUAL REPORTS</h2>
      ...
      <div class="item-grid">
        ...
        @foreach ($reports as $report)
          <div class="item-card">
            <div class="item-banner {{ $report['banner'] }}">
              <span class="item-year">{{ $report['year'] }}</span>
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="13" y2="17"/><line x1="8" y1="9" x2="10" y2="9"/>
              </svg>
            </div>
            <div class="item-body">
