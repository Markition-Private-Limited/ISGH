  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .left-card {
      ...
      /* Desktop dimensions from the Figma design: 566×558 card,
         24.99px radius, 8.33px white border. aspect-ratio keeps the
         near-square proportion while scaling with the column width. */
      ...
      flex-direction: column;
      justify-content: center;
      /* Center the form block on the cross axis. Without this the flex
         column defaults to align-items:stretch, which left-aligns the
         width-capped .form-inner instead of centering it. */
      align-items: center;
      aspect-ratio: 566 / 558;
    }

    .form-inner {
      /* width:100% would make this flex item fill the line and pin to the
         left, defeating align-items:center on .left-card. min() gives a
         definite, already-capped width that the parent can truly center. */
      width: min(100%, 380px);
    }
    ...
    .right-card {
      /* Desktop dimensions from the Figma design: 566×558 card,
         16.66px radius, 8.33px white border. */
    ...
    /* ── Responsive ── */
    /* Below desktop the cards drop the fixed Figma aspect ratio and size to
       their content / a sensible min-height instead. */
    @media (max-width: 960px) {
      .left-card { padding: 40px 32px; aspect-ratio: auto; min-height: auto; }
    ...
    @media (max-width: 860px) {
      ...
      .right-card { aspect-ratio: auto; min-height: 320px; }
      .left-card  { padding: 40px 32px; aspect-ratio: auto; min-height: auto; }
    }
    ...
    @media (max-width: 640px) {
      ...
      /* Mobile hands image — proportions taken from the Figma mobile design:
         312.30 × 374.30 (≈0.834 aspect), 9.25px radius, 4.63px green border. */
      .mobile-join-visual {
        display: block;
        margin-top: 8px;
      }
      .mobile-join-visual .join-visual-frame {
        position: relative;
        overflow: hidden;
        border: 4.63px solid #0c7b52;
        border-radius: 9.25px;
        aspect-ratio: 312.30 / 374.30;
        background: #0c7b52;
      }
