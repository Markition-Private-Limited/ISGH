  ...
  <section class="manage-section w-full py-16 px-5 sm:px-8">
    <div class="max-w-5xl mx-auto text-center">
      ...
      <div class="manage-actions mb-14 sixia" style="flex-direction:row; align-items:center; justify-content:center; gap:16px; flex-wrap:wrap; width:100%;">
        ...
        <a href="{{ route('member-portal.login') }}" class="manage-tab-btn">
...
>
  ...
  <footer class="site-footer" style="background: linear-gradient(135deg, #0a5e3a 0%, #0d7a4e 50%, #12a060 100%); border-radius: 2rem 2rem 0 0; margin-top: 0; border-top: 10px solid white; border-left: 2px solid white; border-right: 2px solid white; box-shadow: 0 -4px 24px rgba(180,220,255,0.25), inset 0 1px 0 rgba(255,255,255,0.15);">
    <div class="footer-desktop max-w-6xl mx-auto px-8 sm:px-12 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
      ...
      <div>
        ...
        <ul class="flex flex-col gap-3 text-green-200 text-sm">
    ...
    <div class="footer-mobile hidden mx-auto w-full max-w-[390px] px-4 pt-10 pb-8">
      <div class="rounded-[34px] bg-[linear-gradient(135deg,#0a5e3a_0%,#0d7a4e_50%,#12a060_100%)] border border-white/20 shadow-[0_20px_45px_rgba(0,0,0,0.18)] px-4 py-5">
        ...
        <div class="mt-6 flex items-center justify-between gap-4">
          ...
          <div class="flex items-center gap-3">
            <a href="https://www.facebook.com/share/1PMpeZKeZZ/" target="_blank" rel="noopener" aria-label="Facebook" class="w-10 h-10 rounded-full border border-white/70 flex items-center justify-center text-white">
              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987H7.898v-2.89h2.54V9.797c0-2.507 1.493-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/></svg>
            </a>
            <a href="https://www.instagram.com/isgh50" target="_blank" rel="noopener" aria-label="Instagram" class="w-10 h-10 rounded-full border border-white/70 flex items-center justify-center text-white">
              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>
            </a>
            <a href="https://www.tiktok.com/@htx.isgh50" target="_blank" rel="noopener" aria-label="TikTok" class="w-10 h-10 rounded-full border border-white/70 flex items-center justify-center text-white">
              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/></svg>
            </a>
          </div>
        </div>
        ...
        <div class="mt-6 grid grid-cols-2 gap-6">
          <div class="text-left">
            ...
            <div class="mt-5">
              ...
              <p class="text-green-100 text-sm"><a href="tel:+17135246615">(713) 524-6615 ext 105</a></p>
            </div>
            <div class="mt-4">
              <h5 class="text-white font-bold text-sm uppercase tracking-wide">Email</h5>
              <p class="text-green-100 text-sm"><a href="mailto:membership.verify@isgh.org">membership.verify@isgh.org</a></p>
            </div>
          </div>
          ...
          <div class="text-left">
            ...
            <ul class="flex flex-col gap-3">
              <li><a href="{{ route('join') }}" class="text-green-100 text-sm">Become a Member</a></li>
              <li><a href="{{ route('membership-verification') }}" class="text-green-100 text-sm">Verify Membership Status</a></li>
              <li><a href="{{ route('member-portal.login') }}" class="text-green-100 text-sm">Sign In</a></li>
              <li><a href="{{ route('join') }}" class="text-green-100 text-sm">Join Now</a></li>
            </ul>
          </div>
        </div>
      </div>
